...
describe('Dashboard page tests', () => {
    ...
    it('should render the dashboard with the proper components', () => {
        ...
        expect(screen.getByTestId('table-studios-with-winners')).toBeInTheDocument();
    ...
    it('should call the right hooks', () => {
        ...
        expect(require('../../hooks/useYearsMultiWinners').useYearsMultiWinners).toHaveBeenCalled();
        expect(require('../../hooks/useStudiosWithWins').useStudioWithWins).toHaveBeenCalled();
        expect(require('../../hooks/useProducersMinMaxInterval').useProducersMinMaxInterval).toHaveBeenCalled();
        expect(require('../../hooks/useMoviesByYear').useMoviesByYear).toHaveBeenCalled();
    });

    it('should refetch the hook after providing a year and clicking the search button', async () => {
        const state_spy = jest.spyOn(require('../../hooks/useMoviesByYear'), 'useMoviesByYear');
