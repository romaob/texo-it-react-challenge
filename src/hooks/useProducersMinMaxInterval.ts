...
import {
  FetchListOfProducersWithMaxMinWinIntervalResponse,
  fetchListOfProducersWithMaxMinWinInterval,
} from '../utils/api';
...
export function useProducersMinMaxInterval(): UseProducersMinMaxIntervalResponse {
  ...
  const [response, setResponse] =
    useState<null | FetchListOfProducersWithMaxMinWinIntervalResponse>(null);
